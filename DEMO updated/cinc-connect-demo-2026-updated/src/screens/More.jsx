...
const RESOURCE_ITEMS = [
  ...
  { label: 'Members List',    icon: <ContactCardIcon />, route: '/members-list' },
        ...
        <div className="more-section">
          ...
          <div className="more-item-list">
            {RESOURCE_ITEMS.map((item) => (
              <button key={item.label} className="more-item-card" onClick={item.route ? () => navigate(item.route) : undefined}>
