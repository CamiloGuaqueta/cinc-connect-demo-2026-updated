...
const CANDIDATES = [
  { id: 1, name: 'Darren Wilson',  role: 'Incumbent – President',  bio: 'Darren has served as Board President for four years and led the initiative to fully fund the Reserve Study, including the funding increase taking effect in January 2027 to keep the community\'s reserves on track.', photo: '/images/personas/darren-wilson.jpg', pdf: 'Darren_Wilson_Platform.pdf' },
  { id: 2, name: 'William Walker', role: 'Challenger',             bio: 'William is a longtime Cardinal Hills resident who wants to expand recreational programming — more organized pickleball and tennis events — and bring more transparency to amenity scheduling.', photo: '/images/personas/william-walker.png', pdf: null },
  { id: 3, name: 'Lisa Thomas',    role: 'Incumbent – Secretary',  bio: 'Lisa has served as Board Secretary for three years, focusing on clearer resident communication, faster meeting-minute turnaround, and modernizing how the community stays informed between meetings.', photo: '/images/avatar-2.jpg', pdf: 'Lisa_Thomas_Platform.pdf' },
  { id: 4, name: 'Daniel Carter',  role: 'Challenger',             bio: 'Daniel is a financial analyst by trade and wants to bring more detailed budget reporting to homeowners, along with a fresh look at vendor contracts up for renewal this year.', photo: '/images/personas/daniel-carter.png', pdf: null },
  { id: 5, name: 'Thomas Lowes',   role: 'Incumbent – Treasurer',  bio: 'Thomas has managed the association\'s finances for five years, overseeing the pool renovation budget and reserve fund contributions while keeping annual assessments predictable.', photo: '/images/avatar-linkedin.jpg', pdf: 'Thomas_Lowes_Platform.pdf' },
]
